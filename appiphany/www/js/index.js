...
function initMap() {
  ...
  heat_red = L.heatLayer([], {minOpacity: 0.8, radius: 25, gradient: {0: '#ff0000', 1: '#ff0000'}}).addTo(map);
  heat_green = L.heatLayer([], {minOpacity: 0.8,radius: 25, gradient: {0: '#00ff00', 1: '#00ff00'}}).addTo(map);
